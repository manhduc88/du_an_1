                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="form-check card-check">
                                                        <input class="form-check-input" type="radio" name="pttt" id="creditcard" value="1" />
                                                        <label class="form-check-label" for="creditcard"> Thẻ tín dụng</label>
                                                        <div class="input-icon">
                                                            <img src="public/assets_client/images/payment-method.png" alt="payment-method" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="cart-summary">
                                ...
                                <ul class="summary-list">
                                    ...
                                    <li>Phí vận chuyển <span><?=number_format($phiship,0,",",".")?><u>đ</u></span></li>                                </ul>
