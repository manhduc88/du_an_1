        ...
        <div class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-wrap text-center">
                    <h2 class="page-title">Bộ sửu tập sản phẩm mới</h2>
                    <ul class="breadcrumb-pages">
                        <li class="page-item"><a class="page-item-link" href="index.php">Trang Chủ</a></li>
                        <li class="page-item">Bộ sửu tập sản phẩm mới</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-4">
                            <div class="product-section-top-left">
                                ...
                                <div class="list-grid-view">
                                    <a href="shop-list.html" class="view-btn list-view"><img class="view-icon" src="public/assets_client/images/view-list.svg" alt="view-list" /></a>
                                    <a href="shop-grid.html" class="view-btn grid-view active"><img class="view-icon" src="public/assets_client/images/view-grid.svg" alt="view-grid" /></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
                    ...
                    <ul class="paginations text-center">
                                    ...
                                    <?php 
                                            for ($i = 1; $i <= $total_pages; $i++) {
                                                ...
                                                echo '<li class="pagination-page '.$color.'"><a href="index.php?act=danhsachspmoi&page='.$i.'" class="pagination-link">'.$i.'</a></li>';
                                               }
                                    ?>
            ...
            <div class="offcanvas-body">
                <div class="sidebar-widget-area">
                    <div class="single-widget search-widget p-0 bg-transparent">
                        <h3 class="widget-title">Tìm Kiếm Ở Đây</h3>
                        <form action="index.php?act=danhsachnhomsp" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control bg-color" id="searchwidget1" placeholder="Product Store" name="kyw" />
