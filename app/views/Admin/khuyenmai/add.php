<form action="../controllers/AdminController.php?act=addkm" method="post" style=" margin: 20px;" enctype="multipart/form-data" >
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="inputClientCompany" class="form-control" name="ma_km">
              </div>
              <div class="form-group">
                <label for="inputClientCompany">Phần trăm khuyến mãi</label>
                <input type="number" id="inputClientCompany" class="form-control" name="phantram_km">
              </div>
              <div class="form-group">
                <label for="inputClientCompany">Ngày bắt đầu</label>
                <input type="date" id="inputClientCompany" class="form-control" name="ngay_batdau">
              </div>
              <div class="form-group">
                <label for="inputClientCompany">Ngày kết thúc</label>
                <input type="date" id="inputClientCompany" class="form-control" name="ngay_ketthuc">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
