<form action="../controllers/AdminController.php?act=addmau" method="post" style=" margin: 20px;" enctype="multipart/form-data" >
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="inputClientCompany">Tên màu sắc</label>
                <input type="text" id="inputClientCompany" class="form-control" name="ten_mau">
              </div>
              <div class="form-group">
                <label for="inputProjectLeader">Hình màu sắc</label> <br>
                <input type="file" name="hinh_mau" >
              </div>
            </div>
            <!-- /.card-body -->
          </div>
